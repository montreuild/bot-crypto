...
> Ce registre décrit les constats *tels que trouvés*. **Les 35 sont traités**,
> les 11 P1 compris. Quatre constats postérieurs
> ([`18-TROUS-EN-AVAL.md`](18-TROUS-EN-AVAL.md)) s'y sont ajoutés ; il en reste
> **un seul ouvert**, `DOWN-04`.
