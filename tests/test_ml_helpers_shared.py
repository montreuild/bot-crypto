...
# Sont volontairement absentes les PRESETS (sous-classes de V11 sans aucun
# code de features : v7, v10_retrained, les quatre variantes _no_ml) et V11
# lui-même, qui délègue tout à MLBackend et n'importe même plus ces helpers.
# Les y inscrire testerait l'absence d'imports qu'on vient de supprimer à
# dessein ; la propriété « pas de copie locale » reste couverte par le test
# global ci-dessous.
FACTORED_STRATEGIES = [
