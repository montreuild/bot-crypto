...
class Strategy(BaseStrategyML):
    ...
    def prepare_for_backtest(self, df: pl.DataFrame) -> None:
        try:
            # Catalogue partagé "v4_polars" : v7/v10_retrained/v11/opus_stat_retrained_v4
            # ont un _build_features identique (vérifié) → calcul mutualisé sur disque.
            # NB : garder ces builders synchronisés, sinon bump version.
    ...
    _TRAIN_STATE_ATTRS = ('_amp_models', '_dir_models', '_amp_cal', '_dir_cal', '_feature_cols',
                         '_kept_features', '_medians', '_best_auc_per_tf', '_train_meta')
