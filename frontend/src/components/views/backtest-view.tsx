...
import {
  Play, Square, Loader2, AlertCircle, CheckCircle2, TrendingUp, Rocket,
  Maximize2, FileDown, X, Zap, Shield,
} from 'lucide-react';
...
function Verdict({ result }: { result: BacktestResult | BacktestResult[] }) {
...
function BacktestResults({ result, scoreThreshold }: { result: BacktestResult | BacktestResult[]; scoreThreshold?: number | null }) {
  const r = unwrapBacktest(result);
  const byStrategy = r?.by_strategy || {};
