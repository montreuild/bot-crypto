...
/**
 * Onglet « Multi-TF Batch » de `/lab` — rejeu multi-timeframe batch,
 * Walk-Forward + Monte-Carlo.
 *
 * Anciennement l'unique vue Replay. Renommée quand le replay interactif
 * bougie-par-bougie (RPL-001) a été ajouté — les deux features coexistent
 * désormais sous deux onglets séparés dans le Lab.
 */
...
export function MultiTfBatchView() {
